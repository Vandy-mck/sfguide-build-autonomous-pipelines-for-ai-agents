...
id: build-autonomous-pipelines-for-ai-agents
...
```bash
git clone https://github.com/Snowflake-Labs/build-autonomous-pipelines-for-ai-agents
cd build-autonomous-pipelines-for-ai-agents
```

The repository includes the DCM project definitions, Kafka producer/consumer scripts, fraud detection notebook, Cortex Agent SQL, Streamlit app prompts, and helper scripts referenced in each step.
